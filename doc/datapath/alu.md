...
`op` | `ALU_BITWISE_XOR` | 5b'10011 | 同上
`op` | `ALU_LOGICAL_AND` | 5b'11000 | 逻辑与运算
`op` | `ALU_LOGICAL_OR` | 5b'11001 | 逻辑或运算
`op` | `ALU_LOGICAL_NOT` | 5b'11010 | 逻辑非运算
...
2. 可能以后会有 `sig_comp_result`，但是不确定
3. 如果不确定符号，就加上 `$(un_|)signed`
