...
类别 | 定义 | 值 | 意义
--- | --- | --- | ---
数据通路类型 | `UNKNOWN_TYPE` | `4'b0000` | 数据通路未知
数据通路类型 | `UNK_TYPE` | `UNKNOWN_TYPE` | 
...
数据通路类型 | `JUMP_I` | `4'b0110` | 数据通路类型为 `j` 型指令
数据通路类型 | `JUMP_R` | `4'b0111` | 数据通路类型为 `jr` 型指令
数据通路类型 | `CMOV` | `4'b1000` | 数据通路类型为条件传送指令
数据通路类型 | `NOP_TYPE` | `4'b1111` | 数据通路类型为 nop 指令，也是临时开一栏
