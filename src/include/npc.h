...
`define NPC_JUMP_WHEN_EQUAL 4'b0001
`define NPC_JUMP_WHEN_EQUALS_TO `NPC_JUMP_WHEN_EQUAL
`define NPC_EQUAL `NPC_JUMP_WHEN_EQUAL
`define NPC_JUMP_WHEN_NOT_EQUAL 4'b0010
`define NPC_JUMP_WHEN_NOT_EQUALS_TO `NPC_JUMP_WHEN_NOT_EQUAL
`define NPC_NOT_EQUAL `NPC_JUMP_WHEN_NOT_EQUAL
