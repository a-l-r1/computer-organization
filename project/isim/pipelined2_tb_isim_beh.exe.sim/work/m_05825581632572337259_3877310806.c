...
static void Cont_315_8(char *t0)
{
    char t6[8];
    char *t1;
    char *t2;
...
static void Cont_396_11(char *t0)
{
    char t3[8];
    char t4[8];
    char t6[8];
