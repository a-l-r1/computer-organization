...
static unsigned int ng11[] = {20476U, 0U};
...
LAB5:    xsi_set_current_line(22, ng0);
    ...
    t6 = ((char*)((ng10)));
    xsi_vlogfile_readmemh(ng6, 0, t1, 1, *((unsigned int *)t37), 1, *((unsigned int *)t6));
...
LAB47:    t125 = (t39 + 4);
    t126 = *((unsigned int *)t39);
    t127 = *((unsigned int *)t125);
    t128 = (t126 || t127);
    if (t128 > 0)
        goto LAB48;

LAB49:    t149 = *((unsigned int *)t39);
    t150 = (~(t149));
...
LAB36:    if (*((unsigned int *)t72) < *((unsigned int *)t71))
        goto LAB35;
...
LAB48:    t129 = (t0 + 2088);
    ...
    *((unsigned int *)t139) = (t147 & 2047U);
    t148 = *((unsigned int *)t140);
    *((unsigned int *)t140) = (t148 & 2047U);
    xsi_vlog_generic_get_array_select_value(t132, 32, t131, t135, t138, 2, 1, t139, 11, 2);
    goto LAB49;

LAB50:    t153 = ((char*)((ng3)));
    goto LAB51;

LAB52:    xsi_vlog_unsigned_bit_combine(t38, 32, t132, 32, t153, 32);
    goto LAB56;

LAB54:    memcpy(t38, t132, 8);
    goto LAB56;

}


extern void work_m_09912263672057591694_3037376393_init()
{
	static char *pe[] = {(void *)Initial_17_0,(void *)Cont_28_1,(void *)Cont_35_2,(void *)Cont_37_3};
	xsi_register_didat("work_m_09912263672057591694_3037376393", "isim/p7_l0_delay_mips_txt_isim_beh.exe.sim/work/m_09912263672057591694_3037376393.didat");
