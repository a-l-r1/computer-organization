...
static void Cont_521_16(char *t0)
{
    char t3[8];
    char t4[8];
    char t6[8];
...
static void Cont_538_17(char *t0)
{
    char t6[8];
    char *t1;
    char *t2;
